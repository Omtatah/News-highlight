...
class ArticlesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        Set up method that will run before every Test
        '''
        self.new_article = Articles('CNN','Murtallah Omtatah','The tech scene in Africa-Is it the next big thing?','A look at various tech hubs in Africa and the impact they have on the worlds economy','techie.com','techie.com/7643t94.jpg','2019-05-18T23:47:16Z')
    ...
    def test_to_check_instance_variables(self):
        ...
        self.assertEquals(self.new_article.author,'Murtallah Omtatah')
        ...
        self.assertEquals(self.new_article.date,'2019-05-18T23:47:16Z')